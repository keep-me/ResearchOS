...
def _isolate_workspace_runtime_state(monkeypatch: pytest.MonkeyPatch, tmp_path):
    ...
    monkeypatch.setattr(workspace_executor, "allowed_roots", lambda: [tmp_path.resolve()])
