...
RESEARCHOS_MCP_SERVER_NAME = "ResearchOS"

RESEARCHOS_CONTEXT_SESSION_ID_ENV = "RESEARCHOS_AGENT_SESSION_ID"
RESEARCHOS_CONTEXT_MODE_ENV = "RESEARCHOS_AGENT_MODE"
RESEARCHOS_CONTEXT_WORKSPACE_PATH_ENV = "RESEARCHOS_AGENT_WORKSPACE_PATH"
RESEARCHOS_CONTEXT_WORKSPACE_SERVER_ID_ENV = "RESEARCHOS_AGENT_WORKSPACE_SERVER_ID"

RESEARCHOS_REMOTE_GENERIC_TOOL_NAMES = {
    "list",
    "ls",
    "glob",
    "grep",
...
RESEARCHOS_DYNAMIC_TOOL_EXCLUDES = {
    "local_shell",
    "plan_exit",
    "question",
}

RESEARCHOS_LEGACY_MCP_TOOL_NAMES = {
    "paper_search",
    "paper_detail",
    "paper_import_arxiv",
    "paper_import_pdf",
...
RESEARCHOS_MANUAL_MCP_TOOL_NAMES: tuple[str, ...] = (
    "web_search",
    "search_arxiv",
    "search_papers",
    "get_paper_detail",
...
def mcp_qualified_tool_name(
    tool_name: str,
    server_name: str = RESEARCHOS_MCP_SERVER_NAME,
) -> str:
...
def iter_dynamic_bridge_tool_defs(
    *,
    ...
    for tool_name in sorted(tool_registry_names()):
        if (
            tool_name in RESEARCHOS_DYNAMIC_TOOL_EXCLUDES
            or tool_name in RESEARCHOS_LEGACY_MCP_TOOL_NAMES
...
# Legacy aliases kept only for backward compatibility with historical imports.
CLAW_MCP_SERVER_NAME = RESEARCHOS_MCP_SERVER_NAME
CLAW_CONTEXT_SESSION_ID_ENV = RESEARCHOS_CONTEXT_SESSION_ID_ENV
CLAW_CONTEXT_MODE_ENV = RESEARCHOS_CONTEXT_MODE_ENV
CLAW_CONTEXT_WORKSPACE_PATH_ENV = RESEARCHOS_CONTEXT_WORKSPACE_PATH_ENV
CLAW_CONTEXT_WORKSPACE_SERVER_ID_ENV = RESEARCHOS_CONTEXT_WORKSPACE_SERVER_ID_ENV
CLAW_REMOTE_GENERIC_TOOL_NAMES = RESEARCHOS_REMOTE_GENERIC_TOOL_NAMES
